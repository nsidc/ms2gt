Readme for MODIS Swath-to-Grid Toolbox 0.3 --  1 May 2001
Terry Haran
...
from ftp://baikal.colorado.edu/pub/NSIDC/ms2gt0.3.tar.gz. Save this file in
some directory and type:

gunzip ms2gt0.3.tar.gz
tar xvf ms2gt0.3.tar 
